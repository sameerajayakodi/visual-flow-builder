...
export const NODE_LIBRARY: NodeLibraryItem[] = [
  ...
  },
  {
    type: 'getInput',
    label: 'Get Media',
    description: 'Collect image, video, audio, or files from the user',
    category: 'message',
    icon: '📎',
    color: '#ec4899',
    defaultData: {
      ...
      saveToVariable: '',
      skippable: false,
      errorMessage: 'Invalid format. Please upload a valid file.',
    } as any,
  },
  ...
  },
  {
    type: 'dbSave',
    label: 'Save to DB',
    description: 'Save or update data in a database collection',
    category: 'action',
    icon: '🗄️',
    color: '#0ea5e9',
    defaultData: {
