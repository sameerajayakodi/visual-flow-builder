...
export const EXAMPLE_FLOWS: Record<string, any> = {
  ...
  customer_support: {
    ...
    nodes: [
      ...
      { id: 'dept', type: 'button', position: { x: 400, y: 340 }, data: { label: 'Choose Dept', nodeType: 'button', category: 'message', icon: '🔘', isConfigured: true, hasError: false, message: 'Select a department:', buttons: [
        { id: 'btn_sup', label: 'Support', value: 'support', type: 'reply' },
        { id: 'btn_sal', label: 'Sales', value: 'sales', type: 'reply' },
  ...
  lead_generation: {
    ...
    nodes: [
      ...
      { id: 'interest', type: 'card', position: { x: 420, y: 610 }, data: { label: 'Service Interest', nodeType: 'card', category: 'message', icon: '🃏', isConfigured: true, hasError: false, title: 'What interests you?', subtitle: 'Pick a plan', body: 'Choose the service that fits your needs.', buttons: [
        { id: 'btn_basic', label: 'Basic Plan', value: 'basic', type: 'reply' },
        { id: 'btn_pro', label: 'Pro Plan', value: 'pro', type: 'reply' },
        { id: 'btn_ent', label: 'Enterprise', value: 'enterprise', type: 'reply' },
      ] } },
  ...
  language_survey: {
    ...
    nodes: [
      ...
      { id: 'q_lang', type: 'questionnaire', position: { x: 400, y: 190 }, data: { label: 'Select Language', nodeType: 'questionnaire', category: 'message', icon: '📋', isConfigured: true, hasError: false, pIndex: 0, promptKey: 'select_language', language: 'ENGLISH', text: 'Please select your preferred language.', promptProps: ['SINGLE_CHOICE'], answers: [
      ...
      { id: 'q_age', type: 'questionnaire', position: { x: 400, y: 400 }, data: { label: 'Age Range', nodeType: 'questionnaire', category: 'message', icon: '📋', isConfigured: true, hasError: false, pIndex: 1, promptKey: 'age_range', language: 'ENGLISH', text: 'What is your age range?', promptProps: ['SINGLE_CHOICE'], answers: [
      ...
      { id: 'q_feedback', type: 'questionnaire', position: { x: 650, y: 620 }, data: { label: 'Service Rating', nodeType: 'questionnaire', category: 'message', icon: '📋', isConfigured: true, hasError: false, pIndex: 2, promptKey: 'user_feedback', language: 'ENGLISH', text: 'Since you are an adult, how would you rate our service?', promptProps: ['SINGLE_CHOICE'], answers: [
        { id: 'ans_good', aIndex: 1, keyPattern: '1', keyPatternHuman: '1', text: 'Good', props: ['BUTTON'] },
        { id: 'ans_avg', aIndex: 2, keyPattern: '2', keyPatternHuman: '2', text: 'Average', props: ['BUTTON'] },
        { id: 'ans_bad', aIndex: 3, keyPattern: '3', keyPatternHuman: '3', text: 'Bad', props: ['BUTTON'] },
      ] } },
      { id: 'q_end', type: 'questionnaire', position: { x: 400, y: 840 }, data: { label: 'Thank You', nodeType: 'questionnaire', category: 'message', icon: '📋', isConfigured: true, hasError: false, pIndex: 99, promptKey: 'end_thank_you', language: 'ENGLISH', text: 'Thank you for participating! Goodbye.', promptProps: ['ENDING'], answers: [] } },
    ],
    edges: [
  ...
  order_notification: {
    ...
    nodes: [
      ...
      { id: 'rate_card', type: 'card', position: { x: 150, y: 1180 }, data: { label: 'Rate Experience', nodeType: 'card', category: 'message', icon: '🃏', isConfigured: true, hasError: false, title: 'How was your order?', subtitle: 'Rate your experience', body: '', buttons: [
        { id: 'btn_5star', label: '⭐ 5 Stars', value: '5', type: 'reply' },
        { id: 'btn_3star', label: '⭐ 3 Stars', value: '3', type: 'reply' },
        { id: 'btn_1star', label: '⭐ 1 Star', value: '1', type: 'reply' },
      ] } },
